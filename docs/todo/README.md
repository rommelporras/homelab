...
> **Latest Release:** v0.39.2 (Argo Events CI/CD Migration - Phase 5.9.1 Stage 2)
...
| v0.39.2 | Argo Events CI/CD Migration | Phase 5.9.1 Stage 2 | ✅ Released |
...
| 5.9 | Argo Workflows | [phase-5.9-argo-workflows.md](completed/phase-5.9-argo-workflows.md) |
| 5.9.1 | CI/CD Pipeline Migration (Stage 1 v0.39.1 + Stage 2 v0.39.2) | [phase-5.9.1-cicd-pipeline-migration.md](completed/phase-5.9.1-cicd-pipeline-migration.md) |
