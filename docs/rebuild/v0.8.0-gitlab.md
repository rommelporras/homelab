...
|-----------|------|--------|
| GitLab | Login | root-password, postgresql-password, runner-token (add after install) |
...
```
Host gitlab.k8s.home.rommelporras.com
...
- [ ] SSH access works: `ssh -T git@gitlab.k8s.home.rommelporras.com`
