...
| Prod (internal) | blog.k8s.home.rommelporras.com | Internal (HTTPRoute) |
...
**manifests/ghost-prod/httproute.yaml:** Same with `namespace: ghost-prod` and hostname `blog.k8s.home.rommelporras.com`.
...
Prod: https://blog.k8s.home.rommelporras.com/ghost/   (internal URL, bypasses WAF)
...
```bash
# Theme repo: gitlab.k8s.home.rommelporras.com/0xwsh/eventually-consistent
